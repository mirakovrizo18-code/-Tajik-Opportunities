...
// Version: 2026.09.09-modern-fixed-v5
//
    ...
    await this.db
      .prepare(`
        ...
        DO UPDATE SET
          ...
          custom_delete_at = excluded.custom_delete_at,
          custom_publish_at = excluded.custom_publish_at,
          custom_author_name = excluded.custom_author_name,
          custom_author_username = excluded.custom_author_username,
          custom_author_avatar_url = excluded.custom_author_avatar_url,
          ...
          custom_tag_icon = excluded.custom_tag_icon,
          custom_tag_color = excluded.custom_tag_color,
          ...
          bookmarks_enabled = excluded.bookmarks_enabled,
